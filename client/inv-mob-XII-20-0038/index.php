...
<head>
    ...
    <title>Invoice | INV.Mob/XII/20/0038</title>
...
<body>
    <div id="wrapper">
                ...
                <tr style="vertical-align: top;">
                    <td class="">
                        ...
                        <div class="td-email">
                            ...
                            &nbsp; <a
                                href="mailto:lingga.pranasucitra@gmail.com?subject=Hello Lingga, about Invoice INV.Mob/XII/22/0038">lingga.pranasucitra@gmail.com</a>
                        </div>
                        <div class="td-site">
            ...
            <table class="table-work">
                ...
                <tr>
                    <td class="bg-td">
                        ...
                        <div>- New Marker Setup with 3D Object (Input 15 Models + Descriptions)</div>
                        <div>- Added Info Panel</div>
                        <div>- Some Revisions (Capture & Video)</div>
                        <div>- Build to .APK</div>
                    </td>
                ...
                <tr>
                    <td class="bg-td">
                        <b>2. Sisa Pembayaran Term 2</b>
                        <div>- <a href="http://pranasucitra.com/client/inv-mob-X-22-0025/" target="_blank">Invoice Term
                                2
                            </a></div>
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right;" class="bg-td">Rp. 4,250,000</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td style="text-align: right; font-size: 0.78em;" class="bg-th"><b>Rp. 4,250,000</b></td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="text-align: right; font-size: 0.78em;" class="bg-yellow"><b>Rp. 4,250,000</b></td>
                </tr>
        ...
        <div class="footer">
            ...
            <div class="signature">
                <div><img src="qr_Images/Dec20th2022.png" alt=""></div>
