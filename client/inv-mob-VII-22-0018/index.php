...
<head>
    ...
    <title>Invoice | INV.Mob/VII/22/0018</title>
    ...
    <div id="wrapper">
        ...
        <div>
            <table class="table-work">
                ...
                <tr>
                    <td class="bg-td">
                        <b>2. Apps Development</b>
                        <div>- Scene Setup, AR Library Setup, Project Settings (Collecting Package Assets)</div>
                        <div>- Github : Publish Repository untuk kebutuhan backup data project.</div>
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right;" class="bg-td">Rp. 3,700,000</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td style="text-align: right; font-size: 0.78em;" class="bg-th"><b>Rp. 3,700,000</b></td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="text-align: right; font-size: 0.78em;" class="bg-green"><b>Rp. Rp. 3,700,000</b></td>
                </tr>
        ...
        <div class="footer">
            ...
            <div class="signature">
                <div><img src="qr_Images/july15th2022.png" alt=""></div>
